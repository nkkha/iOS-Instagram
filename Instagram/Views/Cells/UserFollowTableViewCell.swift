...
class UserFollowTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        nameLabel.frame = CGRect(x: profileImageView.right + 5, y: 0, width: contentView.width - 8 - profileImageView.width, height: labelHeight)
        usernameLabel.frame = CGRect(x: profileImageView.right + 5, y: nameLabel.bottom, width: contentView.width - 8 - profileImageView.width, height: labelHeight)
    }
}
