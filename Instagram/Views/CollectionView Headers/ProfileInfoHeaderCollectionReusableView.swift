...
final class ProfileInfoHeaderCollectionReusableView: UICollectionReusableView {
    ...
    override func layoutSubviews() {
        ...
        followersButton.frame = CGRect(x: postButton.right, y: 5, width: profilePhotoSize, height: buttonHeight).integral
        followingButton.frame = CGRect(x: followersButton.right, y: 5, width: profilePhotoSize, height: buttonHeight).integral
